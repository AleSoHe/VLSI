...
\textbf{Tarea 1} & Transistor mínimo & \textbf{Página} & \thepage/\pageref{LastPage} \\ % Project name and page count
\textbf{VLSI} & Divisor & \textbf{Actualizado en:} & 18/09/2019 \\ % Job number and last updated date
\textbf{Estudiante:} & Alejandro Solís Hernández & \textbf{Profesor:} & Ronny García Ramírez \\ % Designer and reviewer
\end{tabular}}
